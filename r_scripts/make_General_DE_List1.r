...
out_suf <- '_GeneList1_General_DE_genes.txt'
...
for(COMP_NUM in seq(nrow(comp_info))){
  ...
  write.table(gen_DE_df, file = DE_out_file, quote = F, sep = '\t', 
